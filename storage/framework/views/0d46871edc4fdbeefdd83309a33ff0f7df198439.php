...
<script>
    ...
    $(function () {
        ...
        window.refresh_current = "<?php echo e($trans['refresh_current'], false); ?>";
        window.open_in_new = "<?php echo e($trans['open_in_new'], false); ?>";
        window.open_in_pop = "<?php echo e($trans['open_in_pop'], false); ?>";
        window.refresh_succeeded = "<?php echo e($trans['refresh_succeeded'], false); ?>";

        window.use_icon = "<?php echo e($use_icon, false); ?>" == '1';
        window.pass_urls = '<?php echo e($pass_urls, false); ?>'.split(',');
        window.home_title = '<?php echo e($home_title, false); ?>';
        window.home_uri = '<?php echo e($home_uri, false); ?>';
        window.home_icon = '<?php echo e($home_icon, false); ?>';
        window.iframes_index = '<?php echo e($iframes_index, false); ?>';
        window.tabs_left = '<?php echo e($tabs_left, false); ?>';
        window.bind_urls = '<?php echo e($bind_urls, false); ?>';
        window.bind_selecter = '<?php echo e($bind_selecter, false); ?>';
...
<?php echo $__env->make('admin::index', ['header' => strip_tags($header)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wwwroot\moviestickets\webroot\vendor\ichynul\iframe-tabs\src/../resources/views/index/content.blade.php ENDPATH**/ ?>